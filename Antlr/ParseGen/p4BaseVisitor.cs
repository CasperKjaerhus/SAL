...
public partial class p4BaseVisitor<Result> : AbstractParseTreeVisitor<Result>, Ip4Visitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitGlobal([NotNull] p4Parser.GlobalContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMain([NotNull] p4Parser.MainContext context) { return VisitChildren(context); }
	/// <summary>
